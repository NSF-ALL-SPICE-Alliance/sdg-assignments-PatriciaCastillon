...
```{r}
ggplot(data = sdr_data, aes(x= goal_2_score, y = goal_6_score, color = goal_7_score)) +
  geom_point()
```
Interpretation: 
...
The histogram shows that most countries fall between 75-90 in the SDG 11 Score range. Another trend shows that countries in the Sub-Saharan Africa fall lower for SDG 11. On the other hand, E. Europe and C. Asia countries have a higher count of countries, while the OECD countries have higher scores for SDG 11.
